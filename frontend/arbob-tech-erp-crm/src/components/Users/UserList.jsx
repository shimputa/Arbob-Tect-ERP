              ...
              <tbody className={`${isDarkMode ? 'bg-dark-secondary divide-y divide-gray-700' : 'bg-white divide-y divide-gray-200'}`}>
                {displayedUsers.length === 0 ? (
                  ...
                  displayedUsers.map((user) => (
                    <tr key={user.id} className={`${isDarkMode ? 'hover:bg-dark-accent/50' : 'hover:bg-gray-50'}`}>
                      ...
                      <td className={`px-6 py-4 whitespace-nowrap text-sm ${isDarkMode ? 'text-gray-300' : 'text-gray-500'}`}>
                        <span className={`px-2 inline-flex text-xs leading-5 font-semibold rounded-full ${
                          user.role === 'SUPER_ADMIN' ? (isDarkMode ? 'bg-purple-800 text-purple-100' : 'bg-purple-100 text-purple-800') :
                          user.role === 'ADMIN' ? (isDarkMode ? 'bg-blue-800 text-blue-100' : 'bg-blue-100 text-blue-800') :
                          user.role === 'FINANCE_MANAGER' ? (isDarkMode ? 'bg-green-800 text-green-100' : 'bg-green-100 text-green-800') :
                          user.role === 'HR' ? (isDarkMode ? 'bg-yellow-800 text-yellow-100' : 'bg-yellow-100 text-yellow-800') :
                      ...
                      <td className={`px-6 py-4 whitespace-nowrap text-sm ${isDarkMode ? 'text-gray-300' : 'text-gray-500'}`}>
                        <span className={`px-2 inline-flex text-xs leading-5 font-semibold rounded-full ${
                          user.status === 1 ? (isDarkMode ? 'bg-green-800 text-green-100' : 'bg-green-100 text-green-800') : 
