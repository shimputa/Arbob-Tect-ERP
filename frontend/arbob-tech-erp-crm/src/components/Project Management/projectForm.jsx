...
function ProjectForm({ onSubmit, onClose, project, error, formErrors = {}, employees }) {
  ...
  return (
    <div className="fixed inset-y-0 right-0 bg-white w-[520px] shadow-lg p-8 overflow-y-auto">
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <div>
          ...
          <input
            ...
            className={`w-full px-4 py-2 border rounded-md ${
              localFormErrors?.projectName ? 'border-red-500' : 'border-gray-300'
            } focus:ring-2 focus:ring-blue-500`}
          />
          {localFormErrors?.projectName && (
            <p className="text-red-500 text-sm mt-1">{localFormErrors.projectName}</p>
          )}
        </div>
        ...
        <div className="grid grid-cols-2 gap-6">
          ...
          <div>
            ...
            <input
              ...
              className={`w-full px-4 py-2 border rounded-md ${
                localFormErrors?.ownerEmail ? 'border-red-500' : 'border-gray-300'
              } focus:ring-2 focus:ring-blue-500`}
            />
            {localFormErrors?.ownerEmail && (
              <p className="text-red-500 text-sm mt-1">{localFormErrors.ownerEmail}</p>
            )}
          </div>
          <div className="col-span-2">
            ...
            <input
              ...
              className={`w-full px-4 py-2 border rounded-md ${
                localFormErrors?.ownerNumber ? 'border-red-500' : 'border-gray-300'
              } focus:ring-2 focus:ring-blue-500`}
            />
            {localFormErrors?.ownerNumber && (
              <p className="text-red-500 text-sm mt-1">{localFormErrors.ownerNumber}</p>
            )}
          </div>
        </div>
        ...
        <div className="grid grid-cols-3 gap-6">
          <div>
            ...
            <input
              ...
              className={`w-full px-4 py-2 border rounded-md ${
                localFormErrors?.amount ? 'border-red-500' : 'border-gray-300'
              } focus:ring-2 focus:ring-blue-500`}
            />
            {localFormErrors?.amount && (
              <p className="text-red-500 text-sm mt-1">{localFormErrors.amount}</p>
            )}
          </div>
          <div>
            ...
            <input
              ...
              step="1"
              className={`w-full px-4 py-2 border rounded-md ${
                localFormErrors?.tax ? 'border-red-500' : 'border-gray-300'
              } focus:ring-2 focus:ring-blue-500`}
            />
            {localFormErrors?.tax && (
              <p className="text-red-500 text-sm mt-1">{localFormErrors.tax}</p>
            )}
          </div>
          <div>
            <label className="block text-sm font-medium text-gray-700 mb-1">Paid Amount (PKR)*</label>
            <input
              type="number"
              name="paidAmount"
              ...
              className={`w-full px-4 py-2 border rounded-md ${
                localFormErrors?.paidAmount ? 'border-red-500' : 'border-gray-300'
              } focus:ring-2 focus:ring-blue-500`}
            />
            {localFormErrors?.paidAmount && (
              <p className="text-red-500 text-sm mt-1">{localFormErrors.paidAmount}</p>
            )}
          </div>
        </div>
        ...
        <div>
          ...
          {localFormErrors?.collaborators && (
            <p className="text-red-500 text-sm mt-1">{localFormErrors.collaborators}</p>
          )}
        </div>
        ...
        <div className="grid grid-cols-2 gap-6">
          <div>
            <label className="block text-sm font-medium text-gray-700 mb-1">Bonus (PKR)</label>
            <input
              type="number"
              name="bonus"
          ...
          <div>
            <label className="block text-sm font-medium text-gray-700 mb-1">Shared Bonus (Auto)</label>
            <input
              type="text"
        ...
        <div className="grid grid-cols-2 gap-6">
          <div>
            ...
            <input
              ...
              className={`w-full px-4 py-2 border rounded-md ${
                localFormErrors?.startDate ? 'border-red-500' : 'border-gray-300'
              } focus:ring-2 focus:ring-blue-500`}
            />
            {localFormErrors?.startDate && (
              <p className="text-red-500 text-sm mt-1">{localFormErrors.startDate}</p>
            )}
          </div>
          <div>
            ...
            <input
              ...
              className={`w-full px-4 py-2 border rounded-md ${
                localFormErrors?.endDate ? 'border-red-500' : 'border-gray-300'
              } focus:ring-2 focus:ring-blue-500`}
            />
            {localFormErrors?.endDate && (
              <p className="text-red-500 text-sm mt-1">{localFormErrors.endDate}</p>
            )}
          </div>
        </div>
