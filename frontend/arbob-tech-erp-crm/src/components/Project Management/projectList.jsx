                        ...
                        <tr key={project.id} className="hover:bg-gray-50/50 transition-colors duration-150">
                          <td className="px-6 py-4">
                            <div className="flex flex-col space-y-2">
                              <span className="text-base font-semibold text-gray-900">{project.projectName}</span>
                              ...
                              {project.note && (
                                <p className="text-sm text-gray-500 line-clamp-2">{project.note}</p>
                              )}
                            </div>
                          </td>
                          ...
                          <td className="px-6 py-4">
                            <div className="flex flex-col space-y-1">
                              ...
                              <span className="text-sm text-gray-500">{project.ownerEmail}</span>
                              <span className="text-sm text-gray-500">{project.ownerNumber}</span>
                            </div>
                          </td>
                          ...
                          <td className="px-6 py-4">
                            <div className="space-y-2 text-sm">
                              ...
                              <div className="flex justify-between items-center">
                                <span className="text-gray-500">After Tax:</span>
                                <span className="font-medium text-gray-900">PKR {amountAfterTax.toLocaleString()}</span>
                              </div>
                              <div className="flex justify-between items-center">
                                <span className="text-gray-500">Paid:</span>
                                <span className="font-medium text-green-600">PKR {paidAmount.toLocaleString()}</span>
                              </div>
                              <div className="flex justify-between items-center">
                                <span className="text-gray-500">Remaining:</span>
                                <span className="font-medium text-red-600">PKR {remainingAmount.toLocaleString()}</span>
                              </div>
                              <div className="pt-2 mt-2 border-t border-gray-100">
                                <div className="flex justify-between items-center">
                                  <span className="text-gray-500">Bonus:</span>
                                  <span className="font-medium text-gray-900">PKR {bonus.toLocaleString()}</span>
                                </div>
                                <div className="flex justify-between items-center">
                                  <span className="text-gray-500">Shared:</span>
                                  <span className="font-medium text-gray-900">PKR {sharedBonus.toLocaleString()}</span>
                                </div>
                              </div>
                            </div>
                          </td>
